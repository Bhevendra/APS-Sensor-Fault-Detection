...
class DataIngestion:
    ...
    def _init__(self,data_ingestion_config:config_entity.DataIngestionConfig ):
        try:
    ...
    def initiate_data_ingestion(self)->artifact_entity.DataIngestionArtifact:
        try:
            ...
            train_df,test_df = train_test_split(df,test_size=self.data_ingestion.test_size )

            logging.info("create dataset directory folder if not available")
            #crete dataset directory if not availabe
            data = os.path.dirname(self.data_ingestion_config.train_file_path)
